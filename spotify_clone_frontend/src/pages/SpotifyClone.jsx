  ...
  return (
    <div id="screen" className="screen" role="document" aria-label="Spotify 1 mockup">
      ...
      >
        ...
        <div className="sb-logo" style={{ position: 'absolute', left: '24px', top: '24px', width: '131px', height: '40px' }}>
          {/* Inline SVG wordmark for crisp vector rendering per Figma (0:145 VECTOR) */}
          <svg
            className="logo-svg"
            role="img"
            aria-label="Spotify"
